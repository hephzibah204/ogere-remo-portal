...
const SUBMISSION_TYPES = {
  ...
  royalAudiences: {
    ...
    fields: [
      ...
      { k: 'purpose', l: 'Audience Purpose', t: 'text', r: true },
      { k: 'phone', l: 'Phone Number', t: 'text', r: true },
      { k: 'email', l: 'Email Address', t: 'text', r: true },
      { k: 'address', l: 'Residential / Origin Address', t: 'textarea', r: true },
      { k: 'date', l: 'Requested / Scheduled Date', t: 'text' },
      { k: 'time', l: 'Time Slot', t: 'text' },
      { k: 'palace_chamber', l: 'Palace Chamber', t: 'select', o: ['Inner Royal Council Chamber', 'State Reception Hall', 'Palace Secretariat Court', 'Private Audience Room'] },
      { k: 'groupSize', l: 'Party Size', t: 'text' },
      { k: 'status', l: 'Status', t: 'select', o: ['pending', 'confirmed', 'postponed', 'declined', 'completed'] },
      { k: 'notes', l: 'Palace Notes', t: 'textarea' },
    ],
    list: ['id', 'fullName', 'purpose', 'date', 'status', 'email', 'phone'],
  },
  landRegistry: {
