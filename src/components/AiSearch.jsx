...
const PAGES = [
  ...
  { path: '/news/n-tabieorar', label: 'News: Mount Tabieorar Festival 2026', keywords: 'tabieorar mount aladura church ositelu gbenga daniel august prayer festival news' },
  { path: '/news/n5', label: 'News: FRSC Command Complex Commissioning', keywords: 'frsc command office commissioning ologere royal anniversary expressway traffic safety news' },
  { path: '/news/n7', label: 'News: Tetracore 60,000 SCMD CNG Gas Plant', keywords: 'cng gas tetracore industrial energy haulage clean fuel station news' },
  { path: '/news/n-yemogun', label: 'News: Yemogun Street Reconstruction', keywords: 'yemogun road asphalt reconstruction dapo abiodun ogun drainage street news' },
  { path: '/news/n9', label: 'News: 49th Lipakala Day & Crowning', keywords: 'lipakala 49th oluwakemisola miss lipakala 500m fund festival news' },
  { path: '/news/n1', label: 'News: Ogere Digital Portal Preview', keywords: 'digital portal preview launch testing first digital town nigeria news' },
  { path: '/news/n2', label: 'News: OYDA Youth Tech Bootcamp', keywords: 'oyda tech bootcamp solar web development david alaba ositelu college news' },
  { path: '/news/n4', label: 'News: Health Centre Solar Cold Chain', keywords: 'health centre solar power cold chain vaccines maternal clinic news' },
