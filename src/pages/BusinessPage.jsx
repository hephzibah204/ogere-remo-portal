...
const STATIC = [
  { id: 'biz1', name: 'Ogere Resort & Convention Centre', cat: 'Hospitality', ic: '🏨', desc: 'Premier resort & convention centre.', phone: '+234 906 247 0474', website: 'ogereresort.com', address: 'KM 67, Lagos–Ibadan Expressway', rating: '4.4★' },
  { id: 'biz2', name: 'Ositelu Memorial College', cat: 'Education', ic: '🏫', desc: 'Flagship secondary school.', phone: '+234 806 215 8840', address: 'Awomosu Agbato Drive' },
  { id: 'biz3', name: 'Ogere Traditional Market', cat: 'Trade', ic: '🛖', desc: 'Centuries-old market, multi-lingual hub.', phone: '+234 704 957 0510', address: 'WJPM+5G6, Ogere 121107', rating: '4.4★' },
  { id: 'biz4', name: 'Ogere Rice Farmers Cooperative', cat: 'Agriculture', ic: '🌾', desc: 'Supporting rice cultivation in Ogere.', address: 'Ogere Remo hinterland' },
  { id: 'biz5', name: 'Ogere Community Health Centre', cat: 'Health', ic: '🏥', desc: 'Primary healthcare facility.', address: 'Ogere Remo' },
  { id: 'biz6', name: 'Church of the Lord (Aladura) Worldwide', cat: 'Faith', ic: '⛪', desc: 'Global church founded in Ogere.', address: 'Lisa Compound', website: 'tclpfw.org', rating: '4.1★' },
];
